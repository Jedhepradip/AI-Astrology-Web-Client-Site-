    ...
    return (
        ...
        >
            <form
                ...
                className="w-full h-[450px] max-w-[450px] bg-[#00000063] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center justify-center gap-5 px-[30px] rounded-2xl"
            >
                <h1 className="text-[27px] mb-5 text-white font-semibold">
                    Login to <span className="text-blue-400">AI Astrology Web</span>
                </h1>
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`min-w-[150px] cursor-pointer h-[51px] mt-5 text-black font-semibold text-[19px] bg-white rounded-full transition-all duration-200 ${loading

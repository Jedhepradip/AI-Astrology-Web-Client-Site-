  ...
  return (
    ...
    >
      <form
        ...
        className="w-full h-[550px] max-w-[450px] bg-[#00000063] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center justify-center gap-5 px-[30px] rounded-2xl"
      >
        <h1 className="text-[27px] mb-5 text-white font-semibold">
          Register to <span className="text-blue-400">AI Astrology</span>
        </h1>
